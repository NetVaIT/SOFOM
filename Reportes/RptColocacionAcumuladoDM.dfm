inherited dmRptColocacionAcumulado: TdmRptColocacionAcumulado
  inherited adodsReport: TADODataSet
    CommandText = 
      ...
      'IdMarca '#13#10'GROUP BY ProductosDestino.Descripcion, '#13#10'--ProductosTi' +
      'pos.Descripcion, '#13#10'Familias.Descripcion, '#13#10'Marcas.Descripcion, '#13 +
      #10'YEAR(Anexos.Fecha) '#13#10
