inherited dmAntiguedadSaldosPDF: TdmAntiguedadSaldosPDF
  ...
  inherited adodsReport: TADODataSet
    CommandText = 
      ...
      'RazonSocial AS Cliente, '#13#10' CASE WHEN ([dbo].getdateaux() - Cc.Fe' +
      'chaVencimiento < 0) THEN Cc.Saldo ELSE 0 END AS '#39'Vigentes'#39',-- ag' +
      'o 21/17'#13#10'CASE WHEN ([dbo].getdateaux() -  cc.FechaVencimiento<= ' +
      '30) AND ( [dbo].getdateAux() -  cc.FechaVencimiento>0 )  THEN Cc' +
      '.Saldo END AS '#39'Vencidos0a30'#39', -- ago 21/17 ajuste'#13#10#13#10'     CASE W' +
      'HEN  [dbo].getdateAux() -  cc.FechaVencimiento>= 1 THEN Cc.Saldo' +
      ' END as '#39'Saldo Total Vencido'#39', --abr28/17'#13#10'                     ' +
      '  CASE WHEN ( [dbo].getdateAux() -  cc.FechaVencimiento<=60 ) AN' +
      'D ( [dbo].getdateAux() -  cc.FechaVencimiento>30 ) '#13#10'           ' +
      '           THEN Cc.Saldo END AS '#39'Vencidos a 30 d'#237'as'#39', CASE WHEN ' +
      '( [dbo].getdateAux() -  cc.FechaVencimiento<=90 ) AND ( [dbo].ge' +
      'tdateAux() '#13#10'                      - Cc.Fecha > 60 ) THEN Cc.Sal' +
      'do END AS '#39'Vencidos a 60 d'#237'as'#39', CASE WHEN ( [dbo].getdateAux() -' +
      '  cc.FechaVencimiento> 90 ) AND '#13#10'                      ( [dbo].' +
      'getdateAux() -  cc.FechaVencimiento<= 120 ) THEN Cc.Saldo END AS' +
      ' '#39'Vencidos a 90 d'#237'as'#39', CASE WHEN  [dbo].getdateAux() '#13#10'         ' +
      '             -  cc.FechaVencimiento>= 120 THEN Cc.Saldo END AS '#39 +
      'Vencidos m'#225's de 120 d'#237'as'#39#13#10'FROM         CuentasXCobrar AS Cc INN' +
      'ER JOIN'#13#10'                      Personas AS PR ON Cc.IdPersona = ' +
      'PR.IdPersona'#13#10'             left join  Anexos As A ON Cc.IdAnexo=' +
      'A.IdAnexo       -- Por si hubiese algo sin anexo.. aunque no deb' +
    ...
    object adodsReportVencidosmásde120días: TFMTBCDField
    ...
    object adodsReportVencidos0a30: TFMTBCDField
  ...
  inherited ppReport: TppReport
    ...
    inherited ppDetailBand1: TppDetailBand
      ...
      object ppDBText10: TppDBText
        UserName = 'DBText10'
        DataField = 'Vencidos m'#225's de 120 d'#237'as'
        DataPipeline = dbpReport
        DisplayFormat = '$#,0.00;-$#,0.00'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
  ...
  object ADODtStAntXCliente: TADODataSet
    ...
    CommandText = 
      ...
      'ido")  as TotalVencido,'#13#10'Sum (vigentes)as TotalVigentes,'#13#10'Sum (V' +
      'encidos0a30)as Total0a30, '#13#10'SUM ("vencidos a 30 d'#237'as") as Total3' +
      '0Dias, '#13#10'SUM ("vencidos a 60 d'#237'as") as Total60Dias,'#13#10'SUM ("venci' +
      'dos a 90 d'#237'as") as Total90Dias ,'#13#10'-- SUM ("vencidos a 120 d'#237'as")' +
      ' as Total120Dias ,'#13#10'Sum("Vencidos a mas de 120 d'#237'as") as TotalMa' +
      's120Dias'#13#10'  from Vw_AntiguedadSaldosCXC '#13#10'Group BY Cliente'
    Parameters = <>
    Left = 40
    Top = 120
  end
  ...
  object ADODtStCtaActCliente: TADODataSet
    ...
    CursorType = ctStatic
    CommandText = 
      'SELECT        Cc.IdCuentaXCobrar, Cc.IdAnexo, Cc.IdPersona, Cc.I' +
      'dCuentaXCobrarEstatus, A.IdContrato, Con.IdContratoTipo, CT.Iden' +
      'tificador AS TC, CT.Descripcion AS TipoContrato, Con.Identificad' +
      'or AS Contrato, A.Identificador AS Anexo, '#13#10'                    ' +
      '     CASE WHEN AA.Periodo IS NULL THEN 1000 ELSE AA.Periodo END ' +
      'AS Periodo, Cc.Descripcion AS CobroX, CASE WHEN CC.Esmoratorio =' +
      ' 1 THEN cc.IdCuentaXCobrarBase ELSE CC.idCuentaXCobrar END AS Cx' +
      'cBase, '#13#10'                         Cc.Fecha, Cc.FechaVencimiento,' +
      ' CASE WHEN CC.Esmoratorio = 1 THEN AM.Dias ELSE AA.DiasRetraso E' +
      'ND AS DiasVenc, Cc.Total, Cc.Saldo, CASE WHEN CC.Esmoratorio <> ' +
      '1 THEN Cc.Saldo ELSE 0 END AS SaldoA, '#13#10'                        ' +
      ' CASE WHEN CC.Esmoratorio = 1 THEN Cc.Saldo ELSE 0 END AS SaldoM' +
      ', PR.RazonSocial AS Cliente, PR.RFC, Con.MontoAutorizado AS impo' +
      'rteCredito, aC.MontoFiananciar, A.TasaAnual, A.SaldoInsoluto, A.' +
      'TasaMoratoriaAnual, '#13#10'                         P.fechaPago, CI.F' +
      'echa AS FechaFactura'#13#10'FROM            CuentasXCobrar AS Cc INNER' +
      ' JOIN'#13#10'                         Personas AS PR ON Cc.IdPersona =' +
      ' PR.IdPersona LEFT OUTER JOIN'#13#10'                         Anexos A' +
      'S A ON Cc.IdAnexo = A.IdAnexo LEFT OUTER JOIN'#13#10'                 ' +
      '        AnexosCreditos AS aC ON aC.IdAnexo = A.IdAnexo AND aC.Id' +
      'AnexoCreditoEstatus = 1 LEFT OUTER JOIN'#13#10'                       ' +
      '  v_AnexosAmortizaciones AS AA ON AA.IdAnexoCredito = aC.IdAnexo' +
      'Credito AND Cc.IdAnexosAmortizaciones = AA.IdAnexoAmortizacion L' +
      'EFT OUTER JOIN'#13#10'                         CFDI AS CI ON CI.IdCuen' +
      'taXCobrar = Cc.IdCuentaXCobrar LEFT OUTER JOIN'#13#10'                ' +
      '         CuentasXCobrar AS CXCBase ON CXCBase.IdCuentaXCobrar = ' +
      'Cc.IdCuentaXCobrarBase INNER JOIN'#13#10'                         Cont' +
      'ratos AS Con ON A.IdContrato = Con.IdContrato INNER JOIN'#13#10'      ' +
      '                   ContratosTipos AS CT ON Con.IdContratoTipo = ' +
      'CT.IdContratoTipo LEFT OUTER JOIN'#13#10'                             ' +
      '(SELECT        IdAnexo, MAX(FechaPago) AS fechaPago'#13#10'           ' +
      '                    FROM            Pagos'#13#10'                     ' +
      '          GROUP BY IdAnexo) AS P ON P.IdAnexo = Cc.IdAnexo LEFT ' +
      'OUTER JOIN'#13#10'                             (SELECT        IdCuenta' +
      'XCobrar, COUNT(*) AS Dias'#13#10'                               FROM  ' +
      '          AnexosMoratorios'#13#10'                               WHERE' +
      '        (IdAnexoMoratorioEstatus = 1)'#13#10'                         ' +
      '      GROUP BY IdCuentaXCobrar) AS AM ON AM.IdCuentaXCobrar = Cc' +
      '.IdCuentaXCobrar'#13#10'WHERE        (Cc.Saldo > 0.01) AND (Cc.IdPerso' +
      'na = :IdPersona)'#13#10'ORDER BY Cliente, Cc.IdAnexo, Periodo, Cc.Desc' +
      'ripcion, Cc.FechaVencimiento'#13#10
    Parameters = <
      item
        Name = 'IdPersona'
        Attributes = [paSigned]
  ...
  object ppRptCtaActCliente: TppReport
    ...
    object ppHeaderBand3: TppHeaderBand
      ...
      object ppTituloAdeudo: TppLabel
        UserName = 'Titulo'
        AutoSize = False
        Caption = 'Reporte Cuentas Cliente'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clNavy
        Font.Name = 'Times New Roman'
        Font.Size = 18
      ...
      object lblMontaFinanciar: TppLabel
        UserName = 'lblMontaFinanciar'
        AutoSize = False
      ...
      object dbtxtMontoFinanaciar: TppDBText
        UserName = 'dbtxtMontoFinanaciar'
      ...
      object lblSaldoInsoluto: TppLabel
        UserName = 'Label601'
        AutoSize = False
      ...
      object dbtxtSaldoInsolutio: TppDBText
        UserName = 'dbtxtSaldoInsolutio'
      ...
      object lblTasaAnual: TppLabel
        UserName = 'lblTasaAnual'
        AutoSize = False
      ...
      object dbtxtTasaAnual: TppDBText
        UserName = 'dbtxtTasaAnual'
        DataField = 'TasaAnual'
        DataPipeline = ppDBPplnCtaActCliente
  ...
  object ppDBPplnCtaActCliente: TppDBPipeline
    ...
    Left = 280
    Top = 240
    object ppDBPplnCtaActClienteppField1: TppField
    ...
    object ppDBPplnCtaActClienteppField2: TppField
      Alignment = taRightJustify
      FieldAlias = 'IdAnexo'
      FieldName = 'IdAnexo'
      FieldLength = 0
    ...
    object ppDBPplnCtaActClienteppField3: TppField
      Alignment = taRightJustify
    ...
    object ppDBPplnCtaActClienteppField4: TppField
      Alignment = taRightJustify
      FieldAlias = 'IdCuentaXCobrarEstatus'
      FieldName = 'IdCuentaXCobrarEstatus'
      FieldLength = 0
      DataType = dtInteger
      DisplayWidth = 10
    ...
    object ppDBPplnCtaActClienteppField5: TppField
      Alignment = taRightJustify
    ...
    object ppDBPplnCtaActClienteppField6: TppField
      Alignment = taRightJustify
      FieldAlias = 'IdContratoTipo'
      FieldName = 'IdContratoTipo'
      FieldLength = 0
      DataType = dtInteger
      DisplayWidth = 10
    ...
    object ppDBPplnCtaActClienteppField7: TppField
      FieldAlias = 'TC'
      FieldName = 'TC'
      FieldLength = 5
      DisplayWidth = 5
    ...
    object ppDBPplnCtaActClienteppField8: TppField
    ...
    object ppDBPplnCtaActClienteppField9: TppField
      FieldAlias = 'Contrato'
      FieldName = 'Contrato'
      FieldLength = 20
      DisplayWidth = 20
    ...
    object ppDBPplnCtaActClienteppField10: TppField
      FieldAlias = 'Anexo'
      FieldName = 'Anexo'
      FieldLength = 5
      DisplayWidth = 5
    ...
    object ppDBPplnCtaActClienteppField11: TppField
      Alignment = taRightJustify
      FieldAlias = 'Periodo'
      FieldName = 'Periodo'
      FieldLength = 0
    ...
    object ppDBPplnCtaActClienteppField12: TppField
      FieldAlias = 'CobroX'
      FieldName = 'CobroX'
      FieldLength = 100
      DisplayWidth = 100
    ...
    object ppDBPplnCtaActClienteppField13: TppField
      Alignment = taRightJustify
      FieldAlias = 'CxcBase'
      FieldName = 'CxcBase'
      FieldLength = 0
    ...
    object ppDBPplnCtaActClienteppField14: TppField
      FieldAlias = 'Fecha'
      FieldName = 'Fecha'
      FieldLength = 0
      DataType = dtDateTime
    ...
    object ppDBPplnCtaActClienteppField15: TppField
    ...
    object ppDBPplnCtaActClienteppField16: TppField
      Alignment = taRightJustify
      FieldAlias = 'DiasVenc'
      FieldName = 'DiasVenc'
      FieldLength = 0
    ...
    object ppDBPplnCtaActClienteppField17: TppField
      Alignment = taRightJustify
      FieldAlias = 'Total'
      FieldName = 'Total'
      FieldLength = 6
    ...
    object ppDBPplnCtaActClienteppField18: TppField
      Alignment = taRightJustify
      FieldAlias = 'Saldo'
      FieldName = 'Saldo'
      FieldLength = 6
    ...
    object ppDBPplnCtaActClienteppField19: TppField
      Alignment = taRightJustify
      FieldAlias = 'SaldoA'
      FieldName = 'SaldoA'
      FieldLength = 6
    ...
    object ppDBPplnCtaActClienteppField20: TppField
      Alignment = taRightJustify
      FieldAlias = 'SaldoM'
      FieldName = 'SaldoM'
      FieldLength = 6
    ...
    object ppDBPplnCtaActClienteppField21: TppField
      FieldAlias = 'Cliente'
      FieldName = 'Cliente'
      FieldLength = 300
      DisplayWidth = 300
    ...
    object ppDBPplnCtaActClienteppField22: TppField
      FieldAlias = 'RFC'
      FieldName = 'RFC'
      FieldLength = 13
      DisplayWidth = 13
    ...
    object ppDBPplnCtaActClienteppField23: TppField
      Alignment = taRightJustify
      FieldAlias = 'importeCredito'
      FieldName = 'importeCredito'
      FieldLength = 4
      DataType = dtDouble
      DisplayWidth = 20
      Position = 22
    end
    object ppDBPplnCtaActClienteppField24: TppField
      Alignment = taRightJustify
      FieldAlias = 'MontoFiananciar'
    ...
    object ppDBPplnCtaActClienteppField25: TppField
      Alignment = taRightJustify
      FieldAlias = 'TasaAnual'
      FieldName = 'TasaAnual'
      FieldLength = 4
      DataType = dtDouble
      DisplayWidth = 20
    ...
    object ppDBPplnCtaActClienteppField26: TppField
      Alignment = taRightJustify
    ...
    object ppDBPplnCtaActClienteppField27: TppField
      Alignment = taRightJustify
      FieldAlias = 'TasaMoratoriaAnual'
    ...
    object ppDBPplnCtaActClienteppField28: TppField
    ...
    object ppDBPplnCtaActClienteppField29: TppField
  ...
  object ADODtStXContratosVencidos: TADODataSet
    ...
    CursorType = ctStatic
    CommandText = 
      'SELECT   v2.idAnexo,v2.contrato, v2.anexo,v1.Cliente, '#13#10'V2.Total' +
      'CobradoVencido/1000 as TotalCobradoVencido,'#13#10'  Sum(v1.TotalCobra' +
      'doVencido)/1000 sumavencida, V2.TotalVigente/1000 as Totalvigent' +
      'e ,'#13#10' v2.vencidoa30/1000 as vencidoa30,v2.vencidoa60/1000 as ven' +
      'cidoa60,v2.vencidoa90/1000 as vencidoa90 ,v2.vencidomas120/1000 ' +
      'vencidomas120,v2.Total0A30/1000 as Vencido0a30,'#13#10'V2.saldototal/1' +
      '000 as saldototal'#13#10'FROM         vw_AuxVigentesVencidos v1 ,'#13#10'(SE' +
      'LECT    *'#13#10'FROM         vw_AuxVigentesVencidos'#13#10') as V2'#13#10'where '#13 +
      #10'V1.cliente=V2.cliente '#13#10'--and v2.totalcobradoVencido>0'#13#10'group b' +
      'y  v2.idAnexo,v2.contrato, v2.anexo,v1.Cliente, V2.TotalCobradoV' +
      'encido, V2.TotalVigente, V2.VENCIDOa30,v2.vencidoa60,v2.vencidoa' +
      '90,v2.vencidomas120,V2.saldototal, V2.Total0A30'#13#10#13#10'ORDER BY suma' +
      'vencida desc ,v2.totalcobradoVencido  DESC'#13#10
    Parameters = <>
    Left = 64
    Top = 336
    object ADODtStXContratosVencidosidAnexo: TIntegerField
      FieldName = 'idAnexo'
    end
    object ADODtStXContratosVencidoscontrato: TStringField
      FieldName = 'contrato'
    end
    object ADODtStXContratosVencidosanexo: TStringField
      FieldName = 'anexo'
      Size = 5
    end
    object ADODtStXContratosVencidosCliente: TStringField
      FieldName = 'Cliente'
      Size = 300
    end
    object ADODtStXContratosVencidosTotalCobradoVencido: TFMTBCDField
      FieldName = 'TotalCobradoVencido'
      ReadOnly = True
      Precision = 38
      Size = 6
    end
    object ADODtStXContratosVencidossumavencida: TFMTBCDField
      FieldName = 'sumavencida'
      ReadOnly = True
      Precision = 38
      Size = 6
    end
    object ADODtStXContratosVencidosTotalvigente: TFMTBCDField
      FieldName = 'Totalvigente'
      ReadOnly = True
      Precision = 38
      Size = 6
    end
    object ADODtStXContratosVencidosvencidoa30: TFMTBCDField
      FieldName = 'vencidoa30'
      ReadOnly = True
      Precision = 38
      Size = 6
    end
    object ADODtStXContratosVencidosvencidoa60: TFMTBCDField
      FieldName = 'vencidoa60'
      ReadOnly = True
      Precision = 38
      Size = 6
    end
    object ADODtStXContratosVencidosvencidoa90: TFMTBCDField
      FieldName = 'vencidoa90'
      ReadOnly = True
      Precision = 38
      Size = 6
    end
    object ADODtStXContratosVencidosvencidomas120: TFMTBCDField
      FieldName = 'vencidomas120'
      ReadOnly = True
      Precision = 38
      Size = 6
    end
    object ADODtStXContratosVencidosVencido0a30: TFMTBCDField
      FieldName = 'Vencido0a30'
      ReadOnly = True
      Precision = 38
      Size = 6
    end
    object ADODtStXContratosVencidossaldototal: TFMTBCDField
  ...
  object ppRptXContratosVencidos: TppReport
    ...
    object ppHeaderBand4: TppHeaderBand
      ...
      mmHeight = 28310
      mmPrintPosition = 0
      object ppTituloXConVen: TppLabel
        UserName = 'Titulo'
        AutoSize = False
        Caption = 
    ...
    object ppDetailBand4: TppDetailBand
      ...
      object ppDBText26: TppDBText
        UserName = 'DBText3'
        DataField = 'CLiente'
        DataPipeline = ppXContratosVencidos
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
        Font.Size = 7
    ...
    object ppSummaryBand4: TppSummaryBand
      ...
      object ppDBText44: TppDBText
        ...
        DataPipeline = DmReporteCarteraPDF.ppDBSumasTotales
        DisplayFormat = '0 %'
        Font.Charset = DEFAULT_CHARSET
        Font.Color = clBlack
        Font.Name = 'Arial'
