inherited DmReporteCarteraPDF: TDmReporteCarteraPDF
        ...
        object ppChildReport2: TppChildReport
          ...
          object ppDetailBand4: TppDetailBand
            ...
            object ppImage3: TppImage
              ...
              Picture.Data = {
                ...
                
                BD0FEB33BECF1F5C68920000000049454E44AE426082}
              mmHeight = 5821
              mmLeft = 57149
              mmTop = 528
              mmWidth = 5292
          ...
          object ppSummaryBand3: TppSummaryBand
            ...
            object ppSubReport3: TppSubReport
              ...
              OutlineSettings.CreateNode = True
              TraverseAllData = False
              DataPipelineName = 'ppDBPplnMediana'
              mmHeight = 5027
              mmLeft = 0
              mmTop = 2646
              mmWidth = 266700
              ...
              object ppChildReport3: TppChildReport
                ...
                object ppDetailBand5: TppDetailBand
                  ...
                  object ppLblCantidad80: TppLabel
                  ...
                  object ppLblCantidad20: TppLabel
                  ...
                  object ppLblNumCreditos: TppLabel
                  ...
                  object ppLblMontoTotal: TppLabel
                  ...
                  object ppLblMontoPromedioCred: TppLabel
                  ...
                  object ppLblValorMinCred: TppLabel
                  ...
                  object ppLblValorMaxCred: TppLabel
  ...
  object ADODtStRepHojaControlCte: TADODataSet
    ...
    object ADODtStRepHojaControlCteSaldoTotal: TFMTBCDField
      FieldName = 'SaldoTotal'
      ReadOnly = True
      Precision = 38
      Size = 6
    end
    object ADODtStRepHojaControlCtePocAtraORec: TFMTBCDField
  ...
  object AdoDtstPercentiles: TADODataSet
    ...
    OnCalcFields = CuotasReportCalcFields
    CommandText = 
      'SELECT    IdAnexo, TotalPorVencer , TotalPorVencer/vwr2.Total as' +
      ' Parcial'#13#10#13#10'FROM         vw_ReporteCarteraCompleto v1 , (SELECT ' +
      'SUM(TotalPorVencer) as Total'#13#10#13#10'FROM         vw_ReporteCarteraCo' +
      'mpleto ) vwr2'#13#10'ORDER BY TotalPorVencer DESC'#13#10#13#10#13#10
    Parameters = <>
    Left = 312
    Top = 144
  end
  object ADODtStMediana: TADODataSet
    ...
    OnCalcFields = CuotasReportCalcFields
    CommandText = 
      'SELECT'#13#10'('#13#10'(SELECT MIN(TotalPorVencer)  as minimo FROM  (SELECT ' +
      'TOP 50 PERCENT TotalPorVencer FROM   vw_ReporteCarteraCompleto v' +
      '1 Order by TotalPorVencer DESC)AS H2) '#13#10'+   '#13#10'(SELECT MAX(TotalP' +
      'orVencer) as maximo  FROM  (SELECT TOP 50 PERCENT TotalPorVencer' +
      ' FROM   vw_ReporteCarteraCompleto v1 Order by TotalPorVencer )AS' +
      ' H1 )'#13#10') / 2000 AS Mediana;'#13#10#13#10
    Parameters = <>
    Left = 416
    Top = 144
    object ADODtStMedianaMediana: TFMTBCDField
      FieldName = 'Mediana'
      ReadOnly = True
      Precision = 38
      Size = 6
  ...
  object ADODtStRepAmortiza: TADODataSet
    ...
    CursorType = ctStatic
    CommandText = 
      #13#10'select  IdAnexoAmortizacion, AA.IdAnexoCredito, '#13#10'Periodo, aa.' +
      'FechaCorte, aa.FechaVencimiento, '#13#10'AA.ImpactoISR, '#13#10'PagoTotal, S' +
      'aldoFinal, FechaMoratorio, MoratorioBase, DAteDiff(DAY, aa.Fecha' +
      'vencimiento,aa.FechaMoratorio) as Dias,'#13#10'Moratorio, MoratorioImp' +
      'uesto,   ( InteresImpuesto+CapitalImpuesto) as  ImpuestoTotal, C' +
      'apital + aa.interes as Subtotal'#13#10#13#10',CXC.FechaVencimiento FecVenC' +
      'XC , CXC.Total, CXC.Saldo,CXC.IdCuentaXCobrar,Cxc.IdAnexosAmorti' +
      'zaciones --, Ac.IdAnexo A1, Cxc.IdAnexo A2 --, CXC.EsMoratorio'#13#10 +
      ...
      'Mora, VCFDIMora.ultimaFEcha, VCFDIMora.FolioUltimoMora,'#13#10'VcfdiNo' +
      'rmal.FolioUltimoBase, VCFDINormal.ultimaFechaCFDIBase,'#13#10#13#10'A.Iden' +
      'tificador as Anexo, C.Identificador as Contrato, P.RazonSocial, ' +
      'CT.Descripcion as TipoContrato'#13#10'  from AnexosAmortizaciones aa'#13#10 +
      '  inner join AnexosCreditos AC  on AC.IdAnexoCredito=AA.IdAnexoC' +
      'redito  '#13#10'  inner join Anexos A on A.IdAnexo=AC.IdAnexo'#13#10'  inner' +
      ' join Contratos C on C.IdContrato=A.IdContrato'#13#10'  inner join Con' +
      'tratosTipos CT on CT.IdContratoTipo=C.idcontratotipo '#13#10'  inner j' +
      'oin Personas P on P.IdPersona=C.idpersona'#13#10'  '#13#10'  inner  Join Cue' +
      'ntasXCobrar CXC on cXc.IdAnexosAmortizaciones=AA.IdAnexoAmortiza' +
      'cion and CXC.EsMoratorio=0 '#13#10'  '#13#10'  left join (Select  cxc1.IdAne' +
      'xo, cxc1.IdCuentaXCobrarBase ,SUM(Total) TotalMora , Sum(Saldo) ' +
      'SumaSaldoMora, Max(Fecha) ultFEchaMora, Count(Fecha) as cant, MA' +
      'X(idCuentaXCobrar) MaxCXCMora from CuentasXCobrar cxc1 '#13#10'       ' +
      '      where   CXC1.EsMoratorio=1 and Total <>0 Group by cxc1.IdA' +
      'nexo,cxc1.idCuentaXCobrarbase) as VCxcMora '#13#10'             '#13#10'    ' +
      '         on VCxcMora.IdCuentaXCobrarBase=CXC.IdCuentaXCobrar'#13#10'  ' +
      'left join (Select Ci.idcuentaxcobrar, Sum(Total) as TotalCFDi,Co' +
      'unt(fecha) as  cant, max(Fecha) as ultimaFecha , max(folio) Foli' +
      'oUltimoMora from CFDI ci '#13#10#13#10'            group by   Ci.idcuentax' +
      'cobrar) as VCFDIMora  on VCFDIMora.IdCuentaXCobrar=VCxcMora.MaxC' +
      'XCMora'#13#10'  '#13#10'  left join (Select Ci.idcuentaxcobrar, Sum(Total) a' +
      's TotalCFDi,Count(fecha) as  cant, max(Fecha) as ultimaFechaCFDI' +
      'Base , max(folio) FolioUltimoBase from CFDI ci '#13#10#13#10'            g' +
      'roup by   Ci.idcuentaxcobrar) as VCFDINormal  '#13#10'            '#13#10'  ' +
      '          on VCFDINormal.IdCuentaXCobrar=CXC.IdCuentaXCobrar'#13#10'  ' +
      #13#10'  Left Join (Select IdCuentaXCobrar, SUM(Importe) Pagado , Max' +
      '(FechaAplicacion)ultFEcha from PagosAplicaciones '#13#10'             ' +
      ' Group by  IdCuentaXCobrar) as VPagos '#13#10'            on VPagos.Id' +
      'CuentaXCobrar=CXC.IdCuentaXCobrar'#13#10'  '#13#10'    '#13#10'  where CXC.IdAnexo' +
      '=:IdAnexo1'#13#10'   '#13#10'Union'#13#10' select  IdAnexoAmortizacion, AA.IdAnexo' +
      'Credito, '#13#10'Periodo, aa.FechaCorte, aa.FechaVencimiento, '#13#10#13#10'AA.I' +
      'mpactoISR, '#13#10'PagoTotal, SaldoFinal, FechaMoratorio, MoratorioBas' +
      'e, DAteDiff(DAY, aa.Fechavencimiento,aa.FechaMoratorio) as Dias,' +
      #13#10'Moratorio, MoratorioImpuesto,   ( InteresImpuesto+CapitalImpue' +
      'sto) as  ImpuestoTotal, Capital + aa.interes as Subtotal'#13#10',NULL ' +
      'as FechaVencimiento,NULL as Total ,NULL as saldo,NULL as IdCuent' +
      'aXCobrar,NULL IdAnexosAmortizaciones, '#13#10'NULL Pagado,NULL FechaAp' +
      'licacion, NULL totalmora,Null saldoMora,Null ultFEchaMora, Null ' +
      'ultimaFEcha,null FolioUltimoMora ,null FolioUltimoBase,null ulti' +
      'maFechaCFDIBase '#13#10#13#10',A.Identificador as Anexo,C.Identificador as' +
      ' Contrato, P.RazonSocial, CT.Descripcion as TipoContrato'#13#10#13#10'--,C' +
      'XC.FechaVencimiento, CXC.Total, CXC.Saldo,CXC.IdCuentaXCobrar,Cx' +
      'c.IdAnexosAmortizaciones --, Ac.IdAnexo A1, Cxc.IdAnexo A2 --, C' +
      'XC.EsMoratorio'#13#10'--, VPagos.Pagado, VPagos.ultFEcha as FechaAplic' +
      'acion, VCxcMora.TotalMora,VCxcMora.SumaSaldoMora as saldoMora , ' +
      ' VCxcMora.ultFEchaMora, VCFDIMora.ultimaFEcha, VCFDIMora.FolioUl' +
      'timoMora,'#13#10'--VcfdiNormal.FolioUltimoBase, VCFDINormal.ultimaFech' +
      'aCFDIBase'#13#10'  from AnexosAmortizaciones aa'#13#10'  inner join AnexosCr' +
      'editos AC  on AC.IdAnexoCredito=AA.IdAnexoCredito  '#13#10'    inner j' +
      'oin Anexos A on A.IdAnexo=AC.IdAnexo'#13#10'  inner join Contratos C o' +
      'n C.IdContrato=A.IdContrato'#13#10'  inner join ContratosTipos CT on C' +
      'T.IdContratoTipo=C.idcontratotipo '#13#10'  inner join Personas P on P' +
      '.IdPersona=C.idpersona'#13#10'  Where not Exists  (SElect * from Cuent' +
      'asXCobrar Cc where cc.IdAnexosAmortizaciones=aa.IdAnexoAmortizac' +
      'ion)'#13#10'  and Ac.IdAnexo=:IdAnexo2'#13#10'  '
    Parameters = <
      item
        Name = 'IdAnexo1'
        DataType = ftInteger
    ...
    object ADODtStRepAmortizaIdAnexoCredito: TIntegerField
      FieldName = 'IdAnexoCredito'
      ReadOnly = True
    end
    object ADODtStRepAmortizaPeriodo: TIntegerField
      FieldName = 'Periodo'
      ReadOnly = True
    end
    object ADODtStRepAmortizaFechaCorte: TDateTimeField
      FieldName = 'FechaCorte'
      ReadOnly = True
    end
    object ADODtStRepAmortizaFechaVencimiento: TDateTimeField
      FieldName = 'FechaVencimiento'
      ReadOnly = True
    end
    object ADODtStRepAmortizaImpactoISR: TFMTBCDField
      FieldName = 'ImpactoISR'
      ReadOnly = True
      Precision = 18
      Size = 6
    end
    object ADODtStRepAmortizaPagoTotal: TFMTBCDField
      FieldName = 'PagoTotal'
      ReadOnly = True
      Precision = 18
      Size = 6
    end
    object ADODtStRepAmortizaSaldoFinal: TFMTBCDField
      FieldName = 'SaldoFinal'
      ReadOnly = True
      Precision = 18
      Size = 6
    end
    object ADODtStRepAmortizaFechaMoratorio: TDateTimeField
      FieldName = 'FechaMoratorio'
      ReadOnly = True
    end
    object ADODtStRepAmortizaMoratorioBase: TFMTBCDField
      FieldName = 'MoratorioBase'
      ReadOnly = True
      Precision = 18
      Size = 6
    end
    object ADODtStRepAmortizaDias: TIntegerField
      FieldName = 'Dias'
      ReadOnly = True
    end
    object ADODtStRepAmortizaMoratorio: TFMTBCDField
      FieldName = 'Moratorio'
      ReadOnly = True
      Precision = 18
      Size = 6
    end
    object ADODtStRepAmortizaMoratorioImpuesto: TFMTBCDField
      FieldName = 'MoratorioImpuesto'
      ReadOnly = True
      Precision = 18
      Size = 6
    end
    object ADODtStRepAmortizaImpuestoTotal: TFMTBCDField
      FieldName = 'ImpuestoTotal'
      ReadOnly = True
      Precision = 19
      Size = 6
    end
    object ADODtStRepAmortizaSubtotal: TFMTBCDField
      FieldName = 'Subtotal'
      ReadOnly = True
      Precision = 19
      Size = 6
    end
    object ADODtStRepAmortizaFecVenCXC: TDateTimeField
      FieldName = 'FecVenCXC'
      ReadOnly = True
    end
    object ADODtStRepAmortizaTotal: TFMTBCDField
      FieldName = 'Total'
      ReadOnly = True
      Precision = 18
      Size = 6
    end
    object ADODtStRepAmortizaSaldo: TFMTBCDField
      FieldName = 'Saldo'
      ReadOnly = True
      Precision = 18
      Size = 6
    end
    object ADODtStRepAmortizaIdCuentaXCobrar: TIntegerField
      FieldName = 'IdCuentaXCobrar'
      ReadOnly = True
    end
    object ADODtStRepAmortizaIdAnexosAmortizaciones: TIntegerField
      FieldName = 'IdAnexosAmortizaciones'
      ReadOnly = True
    end
    object ADODtStRepAmortizaPagado: TFMTBCDField
      FieldName = 'Pagado'
      ReadOnly = True
      Precision = 38
      Size = 6
    end
    object ADODtStRepAmortizaFechaAplicacion: TDateTimeField
      FieldName = 'FechaAplicacion'
      ReadOnly = True
    end
    object ADODtStRepAmortizaTotalMora: TFMTBCDField
      FieldName = 'TotalMora'
      ReadOnly = True
      Precision = 38
      Size = 6
    end
    object ADODtStRepAmortizasaldoMora: TFMTBCDField
      FieldName = 'saldoMora'
      ReadOnly = True
      Precision = 38
      Size = 6
    end
    object ADODtStRepAmortizaultFEchaMora: TDateTimeField
      FieldName = 'ultFEchaMora'
      ReadOnly = True
    end
    object ADODtStRepAmortizaultimaFEcha: TDateTimeField
      FieldName = 'ultimaFEcha'
      ReadOnly = True
    end
    object ADODtStRepAmortizaFolioUltimoMora: TLargeintField
      FieldName = 'FolioUltimoMora'
      ReadOnly = True
    end
    object ADODtStRepAmortizaFolioUltimoBase: TLargeintField
      FieldName = 'FolioUltimoBase'
      ReadOnly = True
    end
    object ADODtStRepAmortizaultimaFechaCFDIBase: TDateTimeField
      FieldName = 'ultimaFechaCFDIBase'
      ReadOnly = True
    end
    object ADODtStRepAmortizaAnexo: TStringField
      FieldName = 'Anexo'
      ReadOnly = True
      Size = 5
    end
    object ADODtStRepAmortizaContrato: TStringField
      FieldName = 'Contrato'
      ReadOnly = True
    end
    object ADODtStRepAmortizaRazonSocial: TStringField
      FieldName = 'RazonSocial'
      ReadOnly = True
      Size = 300
    end
    object ADODtStRepAmortizaTipoContrato: TStringField
  ...
  object ppRprtRepAmortizayPagos: TppReport
    ...
    PrinterSetup.mmPaperWidth = 279400
    PrinterSetup.PaperSize = 1
    Template.FileName = 'C:\Desarrollo\SOFOM\Reportes\rptResAmortYPagos.rtm'
    Units = utMillimeters
    ArchiveFileName = '($MyDocuments)\ReportArchive.raf'
    DeviceType = 'Screen'
    DefaultFileDeviceType = 'PDF'
