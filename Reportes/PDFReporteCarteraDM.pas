...
type
  TDmReporteCarteraPDF = class(T_dmReportSOFOM)
    ...
    ADtStPagoCXCAdiSA: TADODataSet;
    DSPagosCXCAdiSA: TDataSource;
    ppDBPplnPagosCXCAdiSa: TppDBPipeline;
    ADtStCXCAdicionalSA: TADODataSet;
    DSCXCAdicionalSA: TDataSource;
    ppDBPplCXCAdicionalSa: TppDBPipeline;
    ADtStCXCAdicionalSAIdCuentaXCobrar: TIntegerField;
    ADtStCXCAdicionalSADescripcion: TStringField;
    ADtStCXCAdicionalSAFecha: TDateTimeField;
    ADtStCXCAdicionalSAidanexo: TIntegerField;
    ADtStCXCAdicionalSAimporte: TFMTBCDField;
    ADtStCXCAdicionalSAimpuesto: TFMTBCDField;
    ADtStCXCAdicionalSASaldo: TFMTBCDField;
    ADtStCXCAdicionalSATotal: TFMTBCDField;
    ADtStCXCAdicionalSADescuento: TFMTBCDField;
    ADtStCXCAdicionalSAFolioFac: TLargeintField;
    ADtStCXCAdicionalSAsubtotalFac: TFloatField;
    ADtStCXCAdicionalSAtotalFac: TFMTBCDField;
    ADtStPagoCXCAdiSAidcuentaXcobrar: TIntegerField;
    ADtStPagoCXCAdiSAFechaAplicacion: TDateTimeField;
    ADtStPagoCXCAdiSAImporte: TFMTBCDField;
    ADtStPagoCXCAdiSAFechaPago: TDateTimeField;
    ADtStCXCAdicionalSAFechaFac: TDateTimeField;
