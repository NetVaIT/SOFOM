inherited frmRptPlazas: TfrmRptPlazas
  ...
  inherited dxComponentPrinter: TdxComponentPrinter
    inherited dxcplGrid: TdxGridReportLink
      ReportDocument.CreationDate = 43418.671346203700000000
  ...
  inherited cxpsGrid: TcxPropertiesStore
    Components = <
      ...
      item
        Component = tvMasterCategoriaPuesto
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterCreacionPlaza
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterCreacionPuesto
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterDepartamento
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
