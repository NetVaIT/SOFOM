inherited frmProductos: TfrmProductos
  ...
  inherited cxpsGrid: TcxPropertiesStore
    Components = <
      ...
      item
        Component = tvMasterFechaImportacion
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterIdProductoDestino
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterIdProductoEstatus
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterIdProductoTipo
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterNumeroEconomico
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterPorcentajeComercial
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterPorcentajeContable
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterPrecioMoneda
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterValorComercial
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterValorContable
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
