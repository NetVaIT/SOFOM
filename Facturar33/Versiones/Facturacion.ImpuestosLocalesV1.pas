...
begin
  ...
  FRetencionesLocales := CreateCollection(TImpuestosLocalesV1_RetencionesLocalesList, IImpuestosLocalesV1_RetencionesLocales, 'RetencionesLocales', '') as IImpuestosLocalesV1_RetencionesLocalesList;
  FTrasladosLocales := CreateCollection(TImpuestosLocalesV1_TrasladosLocalesList, IImpuestosLocalesV1_TrasladosLocales, 'TrasladosLocales', '') as IImpuestosLocalesV1_TrasladosLocalesList;
  inherited;
end;
