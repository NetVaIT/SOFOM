...
type
  TFrmMovimientosXCtaBan = class(T_frmGrid)
    ...
    tvMasterSaldoRegistro: TcxGridDBColumn;
    tvMasterHash: TcxGridDBColumn;
    tvMasterIdCuentaBancariaRegistroEstatus: TcxGridDBColumn;
...
var
  FrmMovimientosXCtaBan: TFrmMovimientosXCtaBan;

implementation

{$R *.dfm}

uses CuentasBancariasMovimientosDM;
