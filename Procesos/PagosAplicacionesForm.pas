...
type
  TfrmPagosAplicaciones = class(T_frmGrid)
    ...
    tvMasterImporteFactoraje: TcxGridDBColumn;
    tvMasterCXCFechaVencimiento: TcxGridDBColumn;
    tvMasterAnexo: TcxGridDBColumn;
    tvMasterCXCDescripcion: TcxGridDBColumn;
    tvMasterCFDISerie: TcxGridDBColumn;
    tvMasterCFDIFolio: TcxGridDBColumn;
    tvMasterUUID: TcxGridDBColumn;
    tvMasterCFDIMoneda: TcxGridDBColumn;
