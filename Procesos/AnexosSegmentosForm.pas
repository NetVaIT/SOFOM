...
type
  TfrmAnexosSegmentos = class(T_frmGrid)
    ...
    tvMasterPeriodoInicial: TcxGridDBColumn;
    tvMasterPeriodoFinal: TcxGridDBColumn;
...
uses AnexosSegmentosDM, AnexosSegmentosEdit;

procedure TfrmAnexosSegmentos.FormCreate(Sender: TObject);
begin
  inherited;
  gEditForm := TfrmAnexosSegmentosEdit.Create(Self);
end;
