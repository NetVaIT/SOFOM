inherited dmFacturas: TdmFacturas
  ...
  object ADODtStCFDINotaCredito_PonerenPagos: TADODataSet
    Connection = _dmConection.ADOConnection
    CursorType = ctStatic
    CommandText = 
    ...
    Left = 559
    Top = 465
    object ADODtStCFDINotaCredito_PonerenPagosIdCFDI: TLargeintField
      FieldName = 'IdCFDI'
      ReadOnly = True
    end
    object ADODtStCFDINotaCredito_PonerenPagosIdCFDITipoDocumento: TIntegerField
      FieldName = 'IdCFDITipoDocumento'
    end
    object ADODtStCFDINotaCredito_PonerenPagosIdPersonaReceptor: TIntegerField
      FieldName = 'IdPersonaReceptor'
    end
    object ADODtStCFDINotaCredito_PonerenPagosIdCFDIEstatus: TIntegerField
      FieldName = 'IdCFDIEstatus'
    end
    object ADODtStCFDINotaCredito_PonerenPagosIdClienteDomicilio: TIntegerField
      FieldName = 'IdClienteDomicilio'
    end
    object ADODtStCFDINotaCredito_PonerenPagosSerie: TStringField
      FieldName = 'Serie'
    end
    object ADODtStCFDINotaCredito_PonerenPagosFolio: TLargeintField
      FieldName = 'Folio'
    end
    object ADODtStCFDINotaCredito_PonerenPagosFecha: TDateTimeField
      FieldName = 'Fecha'
    end
    object ADODtStCFDINotaCredito_PonerenPagosSubTotal: TFloatField
      FieldName = 'SubTotal'
    end
    object ADODtStCFDINotaCredito_PonerenPagosTotal: TFMTBCDField
      FieldName = 'Total'
      Precision = 18
      Size = 6
    end
    object ADODtStCFDINotaCredito_PonerenPagosTotalImpuestoTrasladado: TFloatField
      FieldName = 'TotalImpuestoTrasladado'
    end
    object ADODtStCFDINotaCredito_PonerenPagosSaldoDocumento: TFMTBCDField
      FieldName = 'SaldoDocumento'
      Precision = 18
      Size = 6
    end
    object ADODtStCFDINotaCredito_PonerenPagosObservaciones: TStringField
      FieldName = 'Observaciones'
      Size = 300
    end
    object ADODtStCFDINotaCredito_PonerenPagosSaldoFactoraje: TFMTBCDField
      FieldName = 'SaldoFactoraje'
      Precision = 18
      Size = 6
    end
