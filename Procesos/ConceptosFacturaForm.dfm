inherited frmConceptos: TfrmConceptos
  ...
  inherited cxpsGrid: TcxPropertiesStore
    Components = <
      ...
      item
        Component = tvMasterIdUnidadMedida
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterNoIdentifica
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterSATClaveProdServ
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterSATClaveUnidad
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
      ...
      item
        Component = tvMasterValorUnitario
        Properties.Strings = (
          'GroupIndex'
          'SortIndex'
          'SortOrder'
